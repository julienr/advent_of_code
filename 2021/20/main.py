...
prettyprint(image)
enhanced1 = apply_filter(image, algo, cval=0)
prettyprint(enhanced1)
enhanced2 = apply_filter(enhanced1, algo, cval=algo[0])
prettyprint(enhanced2)
print(np.count_nonzero(enhanced2))
